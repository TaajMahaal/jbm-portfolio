...
export const experiences: Experience[] = [
  {
    ...
    highlights: [
      ...
      'Building fintech tools from the ground up',
      'End-to-end ownership of technical architecture and user experience',
      'Rapid prototyping and iteration with AI-assisted development',
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      'Continuous integration deployment preparation',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Development and maintenance of web monitoring interface',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Automated security specification validator development',
  ...
  },
  {
    ...
    highlights: [
      'Security specifications analysis and implementation',
      'High-level smart card framework development',
    ],
  ...
  },
  {
    ...
    highlights: [
      'Fault injection simulator implementation for smart cards',
      'Comparative performance analysis of innovative countermeasures',
    ],
